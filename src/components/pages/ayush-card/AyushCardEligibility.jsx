...
const AyushCardEligibility = () => {
  return (
    <section
      ...
      className="bg-[#F2F4F3] py-14 md:py-20 px-4 sm:px-6 md:px-12"
    >
      <div className="max-w-6xl mx-auto">
        {/* Header flexes differently on mobile vs desktop, keeping it strictly aligned to left as per design */}
        <div className="mb-12">
          <h2 className="text-3xl sm:text-4xl md:text-6xl font-bold text-[#111111]">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          {/* Who Can Apply Card */}
          <div className="flex-1 bg-white rounded-3xl p-6 sm:p-8 md:p-10 shadow-sm">
            <h3 className="text-2xl sm:text-3xl md:text-[40px] font-bold text-[#111111] mb-8">
              Who Can Apply?
            </h3>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <span className="text-[#666666] text-base sm:text-lg md:text-[20px]">
          ...
          <div className="flex-1 bg-white rounded-3xl p-6 sm:p-8 md:p-10 shadow-sm">
            ...
            <div className="space-y-6 tracking-wider">
              <div className="flex items-center gap-4">
                ...
                <span className="text-[#666666] text-base sm:text-lg md:text-[20px]">Aadhaar Card</span>
              </div>
