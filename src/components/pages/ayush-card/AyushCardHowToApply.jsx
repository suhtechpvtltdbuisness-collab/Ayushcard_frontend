    ...
    <section className="bg-[#FFFCFB] py-20 px-6 md:px-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative pl-4 md:pl-0">
          {/* Vertical Line */}
          <div className="absolute top-[30px] bottom-[50px] left-[32px] md:left-[35px] w-0.5 bg-[#F68E5F] z-0"></div>

          <div className="flex flex-col gap-14">
            {stepsData.map((step, index) => (
              <div
                key={index}
                className="flex flex-row relative z-10 items-start gap-8"
              >
                {/* Step Circle */}
                <div className="w-[70px] h-[70px] shrink-0 bg-[#F68E5F] rounded-full flex items-center justify-center shadow-md relative mt-[-10px]">
                ...
                <div className="pt-2">
                  ...
                  <p className="text-[#666666] text-[18px] leading-relaxed max-w-lg">
                    {step.description}
                  </p>
                </div>
              </div>
