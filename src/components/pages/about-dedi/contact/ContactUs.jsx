...
const ContactUs = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setIsSubmitted(true);
    // Reset form after submission if needed, or just show success message
  };
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 text-sm leading-relaxed max-w-xs">
            We're here to help—share your thoughts or inquiries with us, and
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm">
            {isSubmitted ? (
              <div className="flex flex-col items-center justify-center py-10 text-center">
                <div className="w-16 h-16 bg-[#F68E5F] rounded-full flex items-center justify-center mb-6">
                  <ArrowUpRight className="w-8 h-8 text-white rotate-45" />
                </div>
                ...
                <button
                  ...
                  className="text-[#F68E5F] font-semibold hover:underline border-none bg-transparent cursor-pointer"
                >
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm flex items-start gap-4">
              <div className="w-10 h-10 rounded-full bg-[#F68E5F] flex items-center justify-center shrink-0">
