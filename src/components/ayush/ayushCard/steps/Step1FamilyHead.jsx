...
import AadhaarScanOverlay, { AadhaarCameraScanner } from "../components/AadhaarCameraScanner.jsx";
import {
  UploadCard,
  UploadCardActions,
  UploadIdleBox,
} from "../components/UploadCard.jsx";
  ...
  return (
                  <div className="animate-in fade-in slide-in-from-right-4 duration-300">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 w-full">
                      <UploadCard title="Upload head photo" highlighted>
                        {!headImage ? (
                          headCameraActive ? (
                            <div className="w-full border border-[#fa8112]/25 bg-white rounded-lg p-2">
                              <div className="relative aspect-square w-full max-w-[160px] mx-auto rounded-lg overflow-hidden border border-[#F6B579]">
                                <video
                              ...
                              <UploadCardActions>
                                <button
                                  ...
                                  className="flex-[2] py-2 text-[12px] bg-[#fa8112] text-white rounded-lg font-semibold flex items-center justify-center gap-1.5"
                                >
                                ...
                                <button
                                  ...
                                  className="flex-1 py-2 text-[12px] bg-white border border-gray-200 text-gray-600 rounded-lg font-semibold"
                                >
                                  Cancel
                                </button>
                              </UploadCardActions>
                            ...
                            <UploadIdleBox>
                            <div className="border border-dashed border-gray-300 bg-white rounded-lg py-3 px-3 flex flex-col items-center justify-center text-center w-full">
                              <UploadCloud
                              ...
                              <div className="flex gap-2 mt-2 w-full">
                                <button
                                  ...
                                  className="flex-1 py-2 text-[12px] border border-[#fa8112] text-[#fa8112] rounded-lg font-semibold hover:bg-orange-50"
                                >
                                  Upload
                                </button>
                                <button
                                  ...
                                  className="flex-1 py-2 text-[12px] bg-[#fa8112] text-white rounded-lg font-semibold"
                                >
                      ...
                      <UploadCard
                        title="Aadhaar front — scan"
                        subtitle="Name, DOB, gender & Aadhaar no."
                      >
                        {cameraActive ? (
                          <div className="w-full animate-in fade-in zoom-in-95">
                            <AadhaarCameraScanner
                              videoRef={videoRef}
                              hint="Rear camera · card flat in frame"
                            >
                              <AadhaarScanOverlay
                                active={ocrLoading}
                            ...
                            <UploadCardActions>
                              <button
                                ...
                                onClick={stopCamera}
                                disabled={ocrLoading}
                                className="flex-1 py-2 text-[12px] bg-white border border-gray-200 text-gray-600 rounded-lg font-semibold disabled:opacity-50"
                              >
                                Cancel
                              </button>
                              <button
                                ...
                                disabled={ocrLoading}
                                className="flex-[2] py-2 text-[12px] bg-[#fa8112] text-white rounded-lg font-semibold flex items-center justify-center gap-1.5 disabled:opacity-70"
                              >
                                {ocrLoading ? (
                          ...
                          <UploadIdleBox>
                            ...
                            />
                            <div
                              className="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow mb-2 cursor-pointer border border-orange-100 hover:border-[#fa8112]"
                              onClick={ocrLoading ? undefined : startCamera}
                              role="presentation"
                            >
                              {ocrLoading ? (
                                <Loader2 className="animate-spin text-[#fa8112]" size={22} />
                              ) : docFront ? (
                                <Check size={22} className="text-green-600" />
                              ) : (
                                <Camera size={22} className="text-[#fa8112]" />
                              )}
                            </div>
                            ...
                            <div className="flex gap-2 w-full">
                              <button
                                type="button"
                                onClick={startCamera}
                                className="flex-1 py-2 text-[12px] bg-[#fa8112] text-white rounded-lg font-semibold flex items-center justify-center gap-1"
                              >
                              ...
                              <button
                                ...
                                className="flex-1 py-2 text-[12px] bg-white border border-[#fa8112] text-[#fa8112] rounded-lg font-semibold flex items-center justify-center gap-1"
                              >
                                <UploadCloud size={13} /> Gallery
                              </button>
                            </div>
                            {docFront && (
                              <p className="text-[10px] text-green-700 mt-2 text-center truncate max-w-full">
                                {docFront.name}
                              </p>
                            )}
                          </UploadIdleBox>
                      ...
                      <UploadCard title="Aadhaar back — scan" subtitle="Address & pincode">
                        {aadhaarBackCameraActive ? (
                          <div className="w-full animate-in fade-in zoom-in-95">
                            <AadhaarCameraScanner
                              videoRef={aadhaarBackVideoRef}
                              hint="Address side inside frame"
                            >
                              <AadhaarScanOverlay
                            ...
                            <UploadCardActions>
                              ...
                              <button
                                type="button"
                                onClick={captureAadhaarBackPhoto}
                                disabled={backOcrLoading}
                                className="flex-[2] py-2 text-[12px] bg-[#fa8112] text-white rounded-lg font-semibold flex items-center justify-center gap-1.5 disabled:opacity-70"
                              >
                                {backOcrLoading ? (
                          ...
                          <UploadIdleBox>
                            ...
                            <div
                              className="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow mb-2 cursor-pointer border border-orange-100 hover:border-[#fa8112]"
                              onClick={backOcrLoading ? undefined : startAadhaarBackCamera}
                              role="presentation"
                            >
                              {backOcrLoading ? (
                                <Loader2 className="animate-spin text-[#fa8112]" size={22} />
                            ...
                            <div className="flex gap-2 w-full">
                              <button
                                type="button"
                                onClick={startAadhaarBackCamera}
                                className="flex-1 py-2 text-[12px] bg-[#fa8112] text-white rounded-lg font-semibold flex items-center justify-center gap-1"
                              >
                                <Camera size={13} /> Camera
                              </button>
