  ...
  const services = [
    {
      ...
      description:
        "Apply in under 10 minutes with complete document support and guidance.",
    },
    {
      id: 2,
      ...
      description:
        "Hassle-free renewal with automated reminders. Never miss a deadline.",
    },
    {
      id: 3,
      ...
      description:
        "Free eligibility check and expert assistance at every step.",
    },
    {
      id: 4,
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-8">
              Get access to affordable healthcare through government-approved
              Ayush schemes. We handle the paperwork, you focus on your health.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
              {services.map((service) => (
                <div key={service.id} className="flex gap-4 group">
                  <div className="shrink-0 w-12 h-12 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 p-2.5">
                    <img
                      src={service.icon}
                      alt={service.title}
          ...
          <div className="grid grid-cols-2 gap-4 order-1 lg:order-2">
            {stats.map((stat) => (
              ...
              >
                ...
                <div
                  className={`text-sm md:text-base ${stat.bgColor === "bg-white" ? "text-gray-600" : "opacity-80"}`}
                >
                  {stat.label}
                </div>
              </div>
